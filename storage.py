...
class Buffer(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space, recurrent_hidden_state_size, buffer_size):
        ...
        # Memory
        self.obs = torch.zeros(self.size, num_steps + 1, num_processes, *obs_shape, dtype=torch.uint8)
    ...
    def insert(self, obs, recurrent_hidden_states, actions, policies, q_values,
               rewards, masks):
    ...
    def get(self):
        ...
        return obs, recurrent_hidden_states, rewards, policies, q_values, actions, masks
...
class RolloutStorage(object):
    ...
    def insert(self, obs, recurrent_hidden_states, actions, policies, 
